...
header{
  background-image: url(./mohamed-m-uAmgf8kRvqg-unsplash.jpg);
...
.abo{ 
  ...
  height: 100vh;
  display: block;
  background:  url(./fernando-hernandez-lVuV7AcfOrY-unsplash.jpg);
...
aside h3{
  ...
  width: 30%;
  color: aliceblue;
  text-shadow: 1px 1px 40px lightseagreen;
  font-size: 120%;
...
.image img{
  ...
  width: 33%;
  border-radius: 1ex; 
   box-shadow: inset 10px 10px 10px whitesmoke; 
}
.image img:hover{

}
.contac{
  background-image: linear-gradient(rgba(0,0,0,0.6),rgba(0,0,0,0.6),rgba(0,0,0,0.6)) ,url(./robert-shunev-mS1nlYbq1kA-unsplash.jpg);
  background-attachment: fixed;
  background-repeat: no-repeat;
  background-size: cover;
  height: 100vh;
...
.btn{
  ...
  font-weight: 700;
  color: red;
  border: 2px solid #1500f8;
}
footer{
  height: 320px;
  width: 100%;
  background: linear-gradient(rgba(0,0,0,0.8),rgba(0,0,0,0.8),rgba(0,0,0,0.6)), url(./redowan-dhrubo-1KEVqrKDyUs-unsplash.jpg);
  background-attachment: fixed;
  background-size: cover;
